...
int main(int argc, char **argv) {
  ...
  std::vector<double> panda_ready_state{-0.15456131090077108, -0.7735394012228038, 0.12756404116827103, -2.356995592796519, 0.09320660222462873, 1.6010383196085396, 0.3503727355190289};
